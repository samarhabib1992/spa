...
@section('content')
      ...
      <div class="card">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Services Detail</h6>
                        </div>
                      <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <p><strong>Start Time:</strong> 05:00:00 AM</p>
                            </div>
                            <div class="col-md-4">
                                <p><strong>End Time:</strong> 09:00:00 pM</p>
                            </div>
                            <hr class="mt-5">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <p><strong>Website:</strong> https://www.website.com</p>
                            </div>
